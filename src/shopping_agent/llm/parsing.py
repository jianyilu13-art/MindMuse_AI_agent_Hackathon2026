...
class GroqShoppingSemantics:
    ...
    def extract_requirements(self, message: str, current: UserRequirements | None) -> RequirementExtraction:
        ...
        extracted.requirements = _merge_requirements(current, extracted.requirements)
        return extracted
...
def _merge_requirements(current: UserRequirements | None, patch: UserRequirements) -> UserRequirements:
